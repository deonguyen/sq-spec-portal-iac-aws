...
# terraform import aws_secretsmanager_secret.encryption_key_secret arn:aws:secretsmanager:us-east-1:885388406688:secret:sq-spec-portal-backend-ecryption-key-dev-pRQuuM
